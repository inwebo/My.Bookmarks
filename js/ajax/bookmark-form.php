...
<!--
	...
	document.getElementById('bookmarkContainer').innerHTML = "<h1>Add this </h1><form id=\"bookmarkForm\" name=\"bookmarkForm\" method=\"post\" enctype=\"application/x-www-form-urlencoded\" action=\"<?php echo PATH_AJAX; ?>\"><label id=\"labelCategories\">Categories : <br><select id=\"selectCategories\" name=\"selectCategories\"></select></label><label id=\"labelPublic\">Public : <br><input type=\"checkbox\" name=\"public\" id=\"public\"></label><span class=\"clear\"></span><label id=\"labelUrl\">URL : <br><input id=\"url\" disabled=\"disabled\" name=\"url\" value=\"<?php echo $_GET['url']; ?>\" type=\"text\"></label><label id=\"labelTitle\">Title : <br><input id=\"title\" name=\"title\" value=\"<?php echo $_GET['title'] ?>\" type=\"text\"></label><label id=\"labelTags\">Tags : <br></label><label id=\"labelDesc\">Desc : <br></label><hr><a id=\"save\" href=\"#\" title=\"Save it!\" class=\"bookmarker\" onclick=\"saveContent();return false;\">Save</a></form><div id=\"toolBar\"><span><a href=\"#\" title=\"close me\" onclick=\"var mynode = document.getElementById(\'bookmarkContainer\');var parent = mynode.parentNode;parent.removeChild(mynode);return false;\">&#10005;</a></span><span><a href=\"#\" title=\"hide me\" onclick=\"var mynode = document.getElementById(\'bookmarkContainer\');var parent = mynode.parentNode;parent.removeChild(mynode);return false;\">&laquo;</a></span></div>";
