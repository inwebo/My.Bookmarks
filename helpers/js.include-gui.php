...
<script type="text/javascript" src="<?php echo PATH_JS; ?>public-login.js"></script>
<script type="text/javascript" src="<?php echo PATH_JS; ?>public-nav-categories-display.js"></script>
