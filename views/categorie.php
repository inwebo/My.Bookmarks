...
?>
                        ...
                        ?>
			<h2><?php echo urldecode($multiViews->args[2]); ?><span class="totalLinks">&nbsp;<?php echo $totalLinks; ?> urls</span><a id="display-small" href="#" class="totalLinks">Simple</a><a id="display-full" href="#" class="totalLinks">Full</a></h2>
